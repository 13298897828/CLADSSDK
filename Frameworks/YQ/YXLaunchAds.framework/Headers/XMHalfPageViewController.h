...
@protocol XMHalfPageControllerDelegate <NSObject>
...
@interface XMHalfPageViewController : UIViewController
/** 必传参数 **/
...
//回调代理
@property(weak, nonatomic)id<XMHalfPageControllerDelegate> halfDelegate;
